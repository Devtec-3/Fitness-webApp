...
const KineticForge: React.FC = () => {
  const bodyweightExercises: Exercise[] = [
    // --- PUSH PATTERNS ---
    {
      ...
      description:
        "A fundamental upper-body structural integrity protocol focusing on horizontal pressing power.",
      videoUrl:
        "https://youtube.com/results?search_query=perfect+pushups+tutorial",
      formProtocol: [
      ...
      profiles: {
        Low: {
          ...
          reps: "8-12",
          insight:
            "Focus on scapular control and isometric tension at the bottom.",
        },
        Medium: {
          duration: "45s",
          sets: "3",
          reps: "15-20",
          insight:
            "Standard hypertrophy protocol with controlled 2-sec eccentrics.",
        },
        High: {
          duration: "60s",
          sets: "5",
          reps: "25-30",
          insight:
            "Explosive concentric phase for maximum fast-twitch recruitment.",
        },
      },
      modifications: [
        {
          ...
          type: "Regression",
          description:
            "Reduced vertical load via elevated hand placement. Ideal for neural adaptation and high-volume endurance.",
          videoUrl:
            "https://youtube.com/results?search_query=incline+pushups+tutorial",
          formProtocol: [
            "Hands on a bench or elevated surface.",
            "Maintain the same rigid core as standard pushups.",
            "Lower chest all the way to the edge of the surface.",
          ],
          profiles: {
            Low: {
              duration: "30s",
              ...
              reps: "12-15",
              insight:
                "Emphasis on rhythmic breathing and volume accumulation.",
            },
            Medium: {
              duration: "45s",
              sets: "3",
              reps: "20-25",
              insight: "Build endurance without overwhelming shoulder joints.",
            },
            High: {
              duration: "60s",
              sets: "4",
              reps: "30+",
              insight: "High-metabolic conditioning block.",
            },
          },
        },
        {
          ...
          type: "Progression",
          description:
            "High-velocity explosive variation requiring maximum peak power and reactive strength.",
          videoUrl:
            "https://youtube.com/results?search_query=plyometric+pushups+tutorial",
          formProtocol: [
            "Explode off the floor with enough force for hands to leave the ground.",
            "Land with 'soft' elbows to absorb the kinetic energy.",
            "Reset instantly for the next rep to maintain neural drive.",
          ],
          profiles: {
            Low: {
              duration: "20s",
              sets: "3",
              reps: "5-8",
              insight: "Focus on maximum vertical height per rep.",
            },
            Medium: {
              duration: "30s",
              sets: "4",
              reps: "10-12",
              insight: "Sustain power output across the entire set.",
            },
            High: {
              duration: "45s",
              sets: "5",
              reps: "15+",
              insight: "Extreme metabolic and power endurance challenge.",
            },
          },
        },
      ],
    },
    {
      ...
      name: "Neural Squats",
      description:
        "Lower-limb power synthesis and pelvic stability training for athletic base development.",
      ...
      profiles: {
        Low: {
          ...
          sets: "3",
          reps: "15-20",
          insight: "Deep range of motion focus to optimize joint lubrication.",
        },
        Medium: {
          duration: "60s",
          sets: "4",
          reps: "25-30",
          insight: "Metabolic conditioning pace; maintain rhythmic breathing.",
        },
        High: {
          duration: "90s",
          sets: "5",
          reps: "40-50",
          insight: "High-volume structural load; embrace the metabolic burn.",
        },
      },
      modifications: [
        {
          ...
          type: "Progression",
          description:
            "Lateral plane squatting that builds extreme adductor flexibility and hip mobility.",
          videoUrl:
            "https://youtube.com/results?search_query=cossack+squats+tutorial",
          formProtocol: [
            "Wide stance, squat to one side while keeping the other leg fully straight.",
            "Working heel must stay on the floor.",
            "Switch sides with a low transition.",
          ],
          profiles: {
            Low: {
              duration: "40s",
              sets: "2",
              reps: "5/side",
              insight: "Mobility and range of motion priority.",
            },
            Medium: {
              duration: "60s",
              sets: "3",
              reps: "8/side",
              insight: "Controlled strength through the lateral range.",
            },
            High: {
              duration: "90s",
              sets: "4",
              reps: "12/side",
              insight: "Explosive lateral drive out of the bottom.",
            },
          },
        },
      ],
  ...
  const [linkedEcosystem, setLinkedEcosystem] = useState<
    "healthkit" | "googlefit" | null
  >(null);
  ...
  >(() => {
    ...
    bodyweightExercises.forEach((ex) => {
      ...
      ex.modifications?.forEach((mod) => {
        initial[mod.id] = "Medium";
      });
    });
    return initial;
  });
  ...
  useEffect(() => {
    localStorage.setItem(
      "aura-kinetic-archives",
      JSON.stringify(workoutArchives)
    );
  }, [workoutArchives]);

  const activeBaseEx = bodyweightExercises[selectedExIndex];
  const currentEx =
    activeModId && activeBaseEx.modifications?.find((m) => m.id === activeModId)
  ...
  const saveWorkoutToArchives = (
    finalHistory: number[],
    status: "Completed" | "Skipped"
  ) => {
    const totalReps = finalHistory.reduce((acc, curr) => acc + curr, 0);
    const score = Math.floor(
      totalReps * (currentIntensity === "High" ? 1.5 : 1.1) * 10
    );
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-widest">
            {syncStatus === "Connected"
              ? `Synced with ${
                  linkedEcosystem === "healthkit" ? "HealthKit" : "Google Fit"
                }`
              : "Health Sync Offline"}
          </span>
        </div>
          ...
          <section className="bg-white dark:bg-zinc-900 p-8 rounded-[3rem] border border-slate-100 dark:border-zinc-800 shadow-xl overflow-hidden relative">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-600 uppercase tracking-widest">
                  Auto-Sync Protocol
                </p>
              </div>
            </div>
            ...
            {syncStatus === "Disconnected" ? (
              <div className="space-y-3">
                ...
                >
                  ...
                  <CustomChevronRight className="w-4 h-4 text-slate-300 group-hover:text-indigo-500" />
                </button>
                <button
                ...
                >
                  ...
                  <CustomChevronRight className="w-4 h-4 text-slate-300 group-hover:text-emerald-500" />
                </button>
              </div>
            ) : (
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-black text-slate-900 dark:text-white capitalize">
                        {linkedEcosystem} Link
                      </div>
                      <div className="text-[10px] text-slate-400 font-bold uppercase">
                        Last Sync: {syncedMetrics.lastSync}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-white/5 p-5 rounded-3xl border border-white/10 group hover:bg-white/10 transition-all">
                ...
                <div className="text-2xl font-black text-indigo-400 tabular-nums">
                  {syncedMetrics.rhr}
                  <span className="text-[10px] ml-1">BPM</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between group">
                ...
                <span className="text-xs font-black tabular-nums">
                  {syncedMetrics.steps.toLocaleString()} / 10,000
                </span>
              </div>
              <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)] transition-all duration-1000"
                  style={{ width: `${(syncedMetrics.steps / 10000) * 100}%` }}
                ></div>
              </div>
            ...
            {sessionFinished ? (
              <div className="flex flex-col items-center justify-center h-full py-10 text-center space-y-8 animate-in zoom-in duration-500">
                ...
                <div>
                  ...
                  <div className="bg-white/5 p-6 rounded-[2rem] border border-white/5 inline-block">
                    <div className="text-[10px] font-black uppercase text-indigo-400 mb-1">
                      Biological Load Score
                    </div>
                    <div className="text-4xl font-black">
                      +{workoutArchives[0]?.metabolicScore}{" "}
                      <span className="text-sm text-zinc-500">KINETIC</span>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-5 bg-white text-black font-black rounded-3xl hover:bg-zinc-200 transition-all text-[10px] uppercase tracking-widest shadow-xl"
                >
                  Restart Protocol
                </button>
              </div>
              ...
              <>
                ...
                <div className="relative mb-8 group">
                  ...
                  <svg className="w-48 h-48 transform -rotate-90 relative z-10">
                    ...
                    <circle
                      ...
                      fill="transparent"
                      strokeDasharray={552}
                      strokeDashoffset={552 - (552 * timeLeft) / maxDuration}
                ...
                <div className="w-full bg-white/5 p-8 rounded-[2.5rem] border border-white/5 mb-8 text-center">
                  <div className="flex items-center justify-between gap-6 px-4">
                    <button
                      onClick={() =>
                        setCurrentReps(Math.max(0, currentReps - 1))
                      }
                      className="p-4 bg-white/5 rounded-2xl hover:bg-white/10 active:scale-90 transition-all"
                    >
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-[9px] font-black text-indigo-400 uppercase tracking-widest mt-1">
                        Target: {currentProfile.reps}
                      </span>
                    </div>
                    <button
                      onClick={() => setCurrentReps(currentReps + 1)}
                      className="p-4 bg-white/10 rounded-2xl hover:bg-indigo-500 active:scale-90 transition-all"
                    >
                ...
                <div className="flex flex-col w-full gap-4 relative z-10">
                  <div className="flex gap-4">
                    <button
                      onClick={toggleTimer}
                      className={`flex-1 py-6 rounded-3xl transition-all font-black text-xs uppercase tracking-widest ${
                        isTimerRunning
                    ...
                    <button
                      onClick={resetTimer}
                      className="p-6 bg-zinc-900 text-zinc-500 rounded-3xl hover:text-white border border-white/5"
                    >
                  ...
                  <button
                    ...
                    className="w-full py-6 bg-indigo-600 text-white rounded-3xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-indigo-500/20 active:scale-[0.98]"
                  >
        ...
        <section className="lg:col-span-8 space-y-12">
          <div className="bg-white dark:bg-zinc-900 p-10 rounded-[3.5rem] border border-slate-100 dark:border-zinc-800 shadow-xl overflow-hidden relative">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 relative z-10">
              <div>
                <h3 className="font-black text-slate-800 dark:text-zinc-100 text-2xl tracking-tight mb-1">
                  Biokinetic Blueprint
                </h3>
                <p className="text-xs font-bold text-slate-400 dark:text-zinc-600 uppercase tracking-widest">
                  Select structural pattern for sync
                </p>
              </div>
              <div className="flex bg-slate-100 dark:bg-zinc-800 p-1 rounded-2xl">
                <button className="px-6 py-2 bg-white dark:bg-zinc-700 shadow-sm rounded-xl text-[10px] font-black uppercase tracking-widest">
                  Ritual Feed
                </button>
                <button className="px-6 py-2 text-slate-400 text-[10px] font-black uppercase tracking-widest opacity-50 cursor-not-allowed">
                  Load Map
                </button>
              </div>
            </div>
              ...
              {bodyweightExercises.map((ex, i) => {
                ...
                return (
                  <div
                    key={ex.id}
                    onClick={() => {
                      setSelectedExIndex(i);
                      setActiveModId(null);
                    }}
                    className={`group relative p-10 rounded-[3rem] border-2 transition-all cursor-pointer hover:shadow-2xl ${
                      isSelected
                        ? "border-indigo-500 bg-indigo-50/5 shadow-indigo-500/5"
                        : "bg-slate-50 dark:bg-zinc-800/40 border-transparent hover:border-slate-200 dark:hover:border-zinc-700"
                    }`}
                  >
                    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8">
                      <div className="flex-1 space-y-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h4 className="font-black text-slate-900 dark:text-zinc-100 text-2xl tracking-tight leading-none mb-1">
                              {ex.name}
                            </h4>
                            <span className="text-[10px] font-black uppercase text-slate-400 dark:text-zinc-500">
                              {ex.profiles[level].duration} Phase •{" "}
                              {ex.profiles[level].sets} Vol
                            </span>
                          </div>
                        </div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            <button
                              ...
                              className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${
                                !activeModId && isSelected
                                  ? "bg-indigo-600 text-white border-indigo-600"
                                  : "bg-white dark:bg-zinc-700 text-slate-500 border-slate-200 dark:border-zinc-600"
                              }`}
                            >
                              Base Protocol
                            </button>
                      ...
                      <div className="lg:w-48 space-y-4">
                        ...
                        <a
                          href={currentEx.videoUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-center gap-3 w-full py-4 rounded-2xl font-black text-[10px] uppercase bg-slate-900 dark:bg-black text-white shadow-xl hover:bg-slate-800 transition-colors"
                        >
          ...
          <div className="bg-white dark:bg-zinc-900 p-10 rounded-[3.5rem] border border-slate-100 dark:border-zinc-800 shadow-xl overflow-hidden relative">
            <div className="flex items-center justify-between mb-8 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-black text-slate-800 dark:text-zinc-100 text-xl tracking-tight">
                    Kinetic Archives
                  </h3>
                  <p className="text-[10px] font-black text-slate-400 dark:text-zinc-600 uppercase tracking-widest">
                    Ecosystem-Verified Logs
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 max-h-[450px] overflow-y-auto pr-4 custom-scrollbar">
              {workoutArchives.length === 0 ? (
                ...
                workoutArchives.map((log) => (
                  <div
                    key={log.id}
                    className="group bg-slate-50 dark:bg-zinc-800/40 p-6 rounded-[2rem] border border-slate-100 dark:border-zinc-800 flex flex-col md:flex-row md:items-center justify-between gap-6 transition-all hover:border-indigo-200 dark:hover:border-indigo-900/40"
                  >
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h4 className="font-black text-slate-900 dark:text-zinc-100 leading-tight">
                            {log.exerciseName}
                          </h4>
                          {log.synced && (
                            <div
                              className={`flex items-center gap-1 text-[8px] font-black uppercase px-2 py-0.5 rounded border ${
                                log.ecosystemId === "healthkit"
                    ...
                    <div className="flex items-center gap-8">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-xl font-black text-slate-900 dark:text-zinc-100 tabular-nums">
                          {log.totalReps}{" "}
...
// RENAMED TO FIX DUPLICATE ERROR
...
// RENAMED TO FIX DUPLICATE ERROR
const CustomFootprintsIcon = ({ className }: { className: string }) => (
  <svg
    className={className}
    width="24"
    height="24"
